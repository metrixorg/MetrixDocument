...
۱. ابتدا کتابخانه‌ متریکس را از [این لینک](https://github.com/metrixorg/MetrixSDK-UnityPlugin/blob/master/MetrixSDK-v0.12.0.unitypackage) دانلود کنید و در پروژه خود import کنید.
