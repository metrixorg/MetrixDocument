...
<br/>
۱. ابتدا کتابخانه‌ متریکس را از [این لینک](https://github.com/metrixorg/MetrixSDK-UnityPlugin/raw/master/MetrixSDK-v0.15.0.unitypackage) دانلود کنید و در پروژه خود import کنید.
