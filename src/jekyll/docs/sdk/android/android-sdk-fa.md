...
### ۲۱. مشخص کردن Attribute‌های پیش‌فرض همه‌ی رویدادها
...
### ۲۲. مشخص کردن Metricsهای پیش‌فرض همه‌ی رویدادها
...
### ۲۳. اطلاع یافتن از مقدار screenFlow در کتابخانه
