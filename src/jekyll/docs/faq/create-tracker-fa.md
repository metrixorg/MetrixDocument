...
برای اینکه اپلیکیشن خود را به ترکر متریکس مجهز کنید اولین گام این است که مسیر رصد ترافیک اپ خود را مشخص کنید. به این اقدام، **ساخت ترکر** می گویند. لازم است شما به عنوان صاحب اپلیکیشن به ازای تبلیغات موبایلی خود ترکر بسازید. برای این کار لازم است سه مرحله اصلی را پشت سر بگذارید:
...
## مرحله 3: تکمیل لینک‌های ریدایرکت
...
< `{:data-title="توجه" data-color="red"}`
